...
module.exports = "<div *ngIf=\"employee\" class=\"employees\">\n  <h2>{{employee?.employee_name}}'s Details</h2>\n  <ul>\n  <li>ID: {{employee?.id}}</li>\n  <li>Salary: ${{employee?.salary}}</li>\n  <li>Age: {{employee?.employee_age}}</li>\n</ul>\n</div>"
...
/* harmony import */ var _employee_detail_employee_detail_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./employee-detail/employee-detail.component */ "./src/app/employee-detail/employee-detail.component.ts");
...
var appRoutes = [
    {
        path: 'employees',
        component: _employee_employee_component__WEBPACK_IMPORTED_MODULE_7__["EmployeeComponent"],
        data: { title: 'Employee List' }
    },
    {
        path: 'employee-details/:id',
        component: _employee_detail_employee_detail_component__WEBPACK_IMPORTED_MODULE_8__["EmployeeDetailComponent"],
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _employee_detail_employee_detail_component__WEBPACK_IMPORTED_MODULE_8__["EmployeeDetailComponent"]
            ],
            imports: [
...
var EmployeeDetailComponent = /** @class */ (function () {
    function EmployeeDetailComponent(rest, route, router) {
        this.rest = rest;
        this.route = route;
        this.router = router;
    }
    EmployeeDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rest.getEmployee(this.route.snapshot.params['id']).subscribe(function (data) {
            console.log(data);
            _this.employee = data;
        });
    };
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2VtcGxveWVlL0VtcGxveWVlLmNvbXBvbmVudC5jc3MifQ== */"
...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(rest, route, router) {
        this.rest = rest;
        this.route = route;
        this.router = router;
        this.employees = [];
    ...
    EmployeeComponent.prototype.getEmployees = function () {
        var _this = this;
        this.employees = [];
        this.rest.getEmployees().subscribe(function (data) {
            console.log(data);
...
var RestService = /** @class */ (function () {
    function RestService(http) {
        this.http = http;
        this.endpoint = 'http://dummy.restapiexample.com/api/v1/';
        this.httpOptions = {
    ...
    RestService.prototype.getEmployees = function () {
        return this.http.get(this.endpoint + 'employees').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData));
    };
    RestService.prototype.getEmployee = function (id) {
        return this.http.get(this.endpoint + 'employee/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData));
    };
...
module.exports = __webpack_require__(/*! C:\angular_projects\hello-world\src\main.ts */"./src/main.ts");
